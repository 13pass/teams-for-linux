...
>
> **Last Generated**: 2026-07-27T10:40:56.103Z
...
| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `config-file-changed` | Event | Restart application when configuration file changes | [`app/index.js:248`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L248) |
| `dock-icon-update` | Event | Update Dock icon with status overlay on macOS | [`app/index.js:271`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L271) |
| `get-app-version` | Request/Response | Get application version number | [`app/index.js:286`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L286) |
| `get-config` | Request/Response | Get current application configuration | [`app/index.js:250`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L250) |
| `get-navigation-state` | Request/Response | Get current navigation state (can go back/forward) | [`app/index.js:309`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L309) |
| `navigate-back` | Event | Navigate back in browser history | [`app/index.js:291`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L291) |
| `navigate-forward` | Event | Navigate forward in browser history | [`app/index.js:300`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L300) |
| `set-badge-count` | Request/Response | Set application badge count (dock/taskbar notification) | [`app/index.js:268`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L268) |
| `unhandled-rejection` | Event | Log renderer-side unhandled promise rejections | [`app/index.js:318`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L318) |
| `user-status-changed` | Request/Response | Handle user status changes from Teams (e.g., Available, Busy, Away) | [`app/index.js:266`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L266) |
| `window-error` | Event | Log renderer-side uncaught window errors | [`app/index.js:350`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/index.js#L350) |
...
| Channel | Type | Description | Location |
|---------|------|-------------|----------|
| `get-teams-settings` | One-Time Event | Receive Teams settings from renderer to save to file | [`app/menus/index.js:266`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/menus/index.js#L266) |
| `profile-switcher-open-add` | Event | Switcher pill "Add profile…" link opens the existing Add-profile dialog. | [`app/menus/index.js:193`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/menus/index.js#L193) |
| `profile-switcher-open-manage` | Event | Switcher pill "Manage profiles…" link opens the existing Manage dialog. | [`app/menus/index.js:195`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/menus/index.js#L195) |
| `set-teams-settings` | One-Time Event | Acknowledge settings restoration completion from renderer | [`app/menus/index.js:272`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/menus/index.js#L272) |
...
| `graph-api-get-channel-messages` | Request/Response | Get messages in a channel | [`app/graphApi/ipcHandlers.js:141`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/graphApi/ipcHandlers.js#L141) |
| `graph-api-get-channels` | Request/Response | List a team's channels | [`app/graphApi/ipcHandlers.js:130`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/graphApi/ipcHandlers.js#L130) |
| `graph-api-get-chat-messages` | Request/Response | Get messages in a chat | [`app/graphApi/ipcHandlers.js:108`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/graphApi/ipcHandlers.js#L108) |
| `graph-api-get-chats` | Request/Response | List the signed-in user's chats | [`app/graphApi/ipcHandlers.js:97`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/graphApi/ipcHandlers.js#L97) |
| `graph-api-get-joined-teams` | Request/Response | List the teams the user has joined | [`app/graphApi/ipcHandlers.js:119`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/graphApi/ipcHandlers.js#L119) |
...
| `graph-api-probe-message-access` | Request/Response | Probe whether the borrowed token can read chat/channel messages | [`app/graphApi/ipcHandlers.js:152`](https://github.com/IsmaelMartinez/teams-for-linux/blob/develop/app/graphApi/ipcHandlers.js#L152) |
